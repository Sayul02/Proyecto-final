...
import 'package:login_app/Encuestas/encuesta_COVID.dart';
import 'package:cloud_firestore/cloud_firestore.dart';

class InicioPageCOVID extends StatefulWidget {
  @override
  _InicioPageCOVIDState createState() => _InicioPageCOVIDState();
}

class _InicioPageCOVIDState extends State<InicioPageCOVID> {
            ...
            ElevatedButton(
              onPressed: () async {
                if (_nombreController.text.isNotEmpty && _numeroCuentaController.text.isNotEmpty) {
                  ...
                  DocumentReference registroCOVIDDoc = _registroCollection.doc('Registro de COVID');
